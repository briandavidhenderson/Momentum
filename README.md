...
Required for Firebase connection (copy into `.env.local`):

```env
NEXT_PUBLIC_FIREBASE_API_KEY=AIzaSyBYCLKByD0NlVehUynesxeciHPrOGD4NUU
NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN=momentum-a60c5.firebaseapp.com
NEXT_PUBLIC_FIREBASE_PROJECT_ID=momentum-a60c5
NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET=momentum-a60c5.firebasestorage.app
NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID=412082791461
NEXT_PUBLIC_FIREBASE_APP_ID=1:412082791461:web:afab96cc683e5d86920bcc
```
