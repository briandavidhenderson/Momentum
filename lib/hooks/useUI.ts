...
export function useUI() {
  ...
  const [mainView, setMainView] = useState<'dashboard' | 'projects' | 'people' | 'profiles' | 'myprofile' | 'daytoday' | 'mytasks' | 'eln' | 'orders' | 'equipment' | 'bookings' | 'calendar' | 'whiteboard' | 'funding' | 'ledger' | 'privacy' | 'research' | 'explore' | 'reports' | 'safety' | 'samples' | 'mobile_home' | 'groups' | 'training' | 'bench' | 'scan' | 'settings' | 'health' | 'authornetwork'>('dashboard');
